...
const foundDirname =
  ...
  findSync(
    process.cwd(),
    ['src\\generated\\client', 'generated\\client'],
    ['d'],
    ['d'],
    1,
  )[0];
...
const config = {
  generator: {
    ...
    output: {
      value:
        'C:\\Khaimook\\ProjectCode\\65C_NewHRConnext_Backend\\src\\generated\\client',
      fromEnvVar: null,
    },
    config: {
      engineType: 'library',
