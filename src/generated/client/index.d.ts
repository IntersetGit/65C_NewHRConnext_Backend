...
export namespace Prisma {
  ...
  */
  ...
  > = S extends { select: any; include: any }
    ...
    ? {
        [P in TruthyKeys<S['select']>]: P extends keyof CompanyCountOutputType
          ? CompanyCountOutputType[P]
          : never;
      }
    : CompanyCountOutputType;
  ...
  export type CompanyBranchCountOutputTypeGetPayload<
    S extends boolean | null | undefined | CompanyBranchCountOutputTypeArgs,
  > = S extends { select: any; include: any }
    ? 'Please either choose `select` or `include`'
    : S extends true
    ...
    ? {
        [P in TruthyKeys<
          S['select']
        >]: P extends keyof CompanyBranchCountOutputType
          ? CompanyBranchCountOutputType[P]
          : never;
      }
    : CompanyBranchCountOutputType;
  ...
  > = S extends { select: any; include: any }
    ...
    ? {
        [P in TruthyKeys<S['select']>]: P extends keyof RoleCountOutputType
  ...
  export type Role_CompanyCountOutputTypeGetPayload<
    S extends boolean | null | undefined | Role_CompanyCountOutputTypeArgs,
  > = S extends { select: any; include: any }
    ? 'Please either choose `select` or `include`'
    : S extends true
    ...
    ? {
        [P in TruthyKeys<
          S['select']
        >]: P extends keyof Role_CompanyCountOutputType
          ? Role_CompanyCountOutputType[P]
          : never;
      }
    : Role_CompanyCountOutputType;
  ...
  > = S extends { select: any; include: any }
    ...
    ? {
        [P in TruthyKeys<S['select']>]: P extends keyof ProvinceCountOutputType
          ? ProvinceCountOutputType[P]
          : never;
      }
    : ProvinceCountOutputType;
  ...
  export type DistrictCountOutputTypeGetPayload<
    S extends boolean | null | undefined | DistrictCountOutputTypeArgs,
  > = S extends { select: any; include: any }
    ? 'Please either choose `select` or `include`'
    : S extends true
    ...
    ? {
        [P in TruthyKeys<S['select']>]: P extends keyof DistrictCountOutputType
          ? DistrictCountOutputType[P]
          : never;
      }
    : DistrictCountOutputType;
  ...
  export type Mas_positionCountOutputTypeGetPayload<
    S extends boolean | null | undefined | Mas_positionCountOutputTypeArgs,
  > = S extends { select: any; include: any }
    ? 'Please either choose `select` or `include`'
    : S extends true
    ...
    ? {
        [P in TruthyKeys<
          S['select']
        >]: P extends keyof Mas_positionCountOutputType
          ? Mas_positionCountOutputType[P]
          : never;
      }
    : Mas_positionCountOutputType;
  ...
  export type Mas_positionlevel1CountOutputTypeGetPayload<
    S extends
      | boolean
      | null
      | undefined
      | Mas_positionlevel1CountOutputTypeArgs,
  > = S extends { select: any; include: any }
    ? 'Please either choose `select` or `include`'
    : S extends true
    ...
    ? {
        [P in TruthyKeys<
          S['select']
        >]: P extends keyof Mas_positionlevel1CountOutputType
          ? Mas_positionlevel1CountOutputType[P]
          : never;
      }
    : Mas_positionlevel1CountOutputType;
  ...
  export type Mas_positionlevel2CountOutputTypeGetPayload<
    S extends
      | boolean
      | null
      | undefined
      | Mas_positionlevel2CountOutputTypeArgs,
  > = S extends { select: any; include: any }
    ? 'Please either choose `select` or `include`'
    : S extends true
    ...
    ? {
        [P in TruthyKeys<
          S['select']
        >]: P extends keyof Mas_positionlevel2CountOutputType
          ? Mas_positionlevel2CountOutputType[P]
          : never;
      }
    : Mas_positionlevel2CountOutputType;
  ...
  export type Mas_positionlevel3CountOutputTypeGetPayload<
    S extends
      | boolean
      | null
      | undefined
      | Mas_positionlevel3CountOutputTypeArgs,
  > = S extends { select: any; include: any }
    ? 'Please either choose `select` or `include`'
    : S extends true
    ...
    ? {
        [P in TruthyKeys<
          S['select']
        >]: P extends keyof Mas_positionlevel3CountOutputType
          ? Mas_positionlevel3CountOutputType[P]
          : never;
      }
    : Mas_positionlevel3CountOutputType;
  ...
  > = S extends { select: any; include: any }
    ...
    ? Company & {
        [P in TruthyKeys<S['include']>]: P extends 'owner'
          ? UserGetPayload<S['include'][P]>
          : P extends 'branch'
          ? Array<CompanyBranchGetPayload<S['include'][P]>>
          : P extends 'mas_positionlevel3'
          ? Array<mas_positionlevel3GetPayload<S['include'][P]>>
          : P extends 'mas_positionlevel2'
          ? Array<mas_positionlevel2GetPayload<S['include'][P]>>
          : P extends 'mas_positionlevel1'
          ? Array<mas_positionlevel1GetPayload<S['include'][P]>>
          : P extends 'holiday_date'
          ? Array<holiday_dateGetPayload<S['include'][P]>>
          : P extends 'mas_position'
          ? Array<mas_positionGetPayload<S['include'][P]>>
          : P extends '_count'
          ? CompanyCountOutputTypeGetPayload<S['include'][P]>
          : never;
      }
    : S extends { select: any } & (CompanyArgs | CompanyFindManyArgs)
    ? {
        [P in TruthyKeys<S['select']>]: P extends 'owner'
          ? UserGetPayload<S['select'][P]>
          : P extends 'branch'
          ? Array<CompanyBranchGetPayload<S['select'][P]>>
          : P extends 'mas_positionlevel3'
          ? Array<mas_positionlevel3GetPayload<S['select'][P]>>
          : P extends 'mas_positionlevel2'
          ? Array<mas_positionlevel2GetPayload<S['select'][P]>>
          : P extends 'mas_positionlevel1'
          ? Array<mas_positionlevel1GetPayload<S['select'][P]>>
          : P extends 'holiday_date'
          ? Array<holiday_dateGetPayload<S['select'][P]>>
          : P extends 'mas_position'
          ? Array<mas_positionGetPayload<S['select'][P]>>
          : P extends '_count'
          ? CompanyCountOutputTypeGetPayload<S['select'][P]>
          : P extends keyof Company
          ? Company[P]
          : never;
      }
    : Company;
  ...
  > {
     ...
     **/
    findUnique<
      T extends CompanyFindUniqueArgs,
    ...
    > extends True
      ...
      : Prisma__CompanyClient<CompanyGetPayload<T> | null, null>;
     ...
     **/
    findFirst<
      T extends CompanyFindFirstArgs,
      LocalRejectSettings = T['rejectOnNotFound'] extends RejectOnNotFound
        ? T['rejectOnNotFound']
        : undefined,
    >(
    ...
    ): PrismaPromise<GetCompanyAggregateType<T>>;
   ...
   */
  export class Prisma__CompanyClient<T, Null = never>
    implements PrismaPromise<T>
  {
    ...
    branch<T extends CompanyBranchFindManyArgs = {}>(
      args?: Subset<T, CompanyBranchFindManyArgs>,
    ): PrismaPromise<Array<CompanyBranchGetPayload<T>> | Null>;

    mas_positionlevel3<T extends mas_positionlevel3FindManyArgs = {}>(
      args?: Subset<T, mas_positionlevel3FindManyArgs>,
    ): PrismaPromise<Array<mas_positionlevel3GetPayload<T>> | Null>;

    mas_positionlevel2<T extends mas_positionlevel2FindManyArgs = {}>(
      args?: Subset<T, mas_positionlevel2FindManyArgs>,
    ): PrismaPromise<Array<mas_positionlevel2GetPayload<T>> | Null>;

    mas_positionlevel1<T extends mas_positionlevel1FindManyArgs = {}>(
      args?: Subset<T, mas_positionlevel1FindManyArgs>,
    ): PrismaPromise<Array<mas_positionlevel1GetPayload<T>> | Null>;

    holiday_date<T extends Company$holiday_dateArgs = {}>(
      args?: Subset<T, Company$holiday_dateArgs>,
    ): PrismaPromise<Array<holiday_dateGetPayload<T>> | Null>;
  ...
  export type GetCompanyBranchAggregateType<
    T extends CompanyBranchAggregateArgs,
  > = {
  ...
  type GetCompanyBranchGroupByPayload<T extends CompanyBranchGroupByArgs> =
    PrismaPromise<
      Array<
        PickArray<CompanyBranchGroupByOutputType, T['by']> & {
          [P in keyof T &
            keyof CompanyBranchGroupByOutputType]: P extends '_count'
            ? T[P] extends boolean
              ? number
  ...
  export type CompanyBranchGetPayload<
    S extends boolean | null | undefined | CompanyBranchArgs,
  > = S extends { select: any; include: any }
    ? 'Please either choose `select` or `include`'
    : S extends true
    ? CompanyBranch
    ...
    : S extends { include: any } & (
        | CompanyBranchArgs
        | CompanyBranchFindManyArgs
      )
    ? CompanyBranch & {
        [P in TruthyKeys<S['include']>]: P extends 'company'
          ? CompanyGetPayload<S['include'][P]> | null
          : P extends 'users'
          ? Array<UserGetPayload<S['include'][P]>>
          : P extends 'Role_Company'
          ? Array<Role_CompanyGetPayload<S['include'][P]>>
          : P extends '_count'
          ? CompanyBranchCountOutputTypeGetPayload<S['include'][P]>
          : never;
      }
    ...
    ? {
        [P in TruthyKeys<S['select']>]: P extends 'company'
          ? CompanyGetPayload<S['select'][P]> | null
          : P extends 'users'
          ? Array<UserGetPayload<S['select'][P]>>
          : P extends 'Role_Company'
          ? Array<Role_CompanyGetPayload<S['select'][P]>>
          : P extends '_count'
          ? CompanyBranchCountOutputTypeGetPayload<S['select'][P]>
          : P extends keyof CompanyBranch
          ? CompanyBranch[P]
          : never;
      }
    : CompanyBranch;
  ...
  export interface CompanyBranchDelegate<
    GlobalRejectSettings extends
      | Prisma.RejectOnNotFound
      | Prisma.RejectPerOperation
      | false
  ...
  > {
     ...
     **/
    findUnique<
      T extends CompanyBranchFindUniqueArgs,
      LocalRejectSettings = T['rejectOnNotFound'] extends RejectOnNotFound
        ? T['rejectOnNotFound']
        : undefined,
    >(
    ...
    > extends True
      ...
      : Prisma__CompanyBranchClient<CompanyBranchGetPayload<T> | null, null>;
     ...
     **/
    findFirst<
      T extends CompanyBranchFindFirstArgs,
      LocalRejectSettings = T['rejectOnNotFound'] extends RejectOnNotFound
        ? T['rejectOnNotFound']
        : undefined,
    >(
     ...
     * })
     **/
    aggregate<T extends CompanyBranchAggregateArgs>(
      args: Subset<T, CompanyBranchAggregateArgs>,
    ): PrismaPromise<GetCompanyBranchAggregateType<T>>;
    ...
    >(
      args: SubsetIntersection<T, CompanyBranchGroupByArgs, OrderByArg> &
        InputErrors,
    ): {} extends InputErrors
      ? GetCompanyBranchGroupByPayload<T>
      : PrismaPromise<InputErrors>;
  }
   ...
   * https://github.com/prisma/prisma-client-js/issues/707
   */
  export class Prisma__CompanyBranchClient<T, Null = never>
    implements PrismaPromise<T>
  {
    [prisma]: true;
    private readonly _dmmf;
    ...
    company<T extends CompanyArgs = {}>(
      args?: Subset<T, CompanyArgs>,
    ): Prisma__CompanyClient<CompanyGetPayload<T> | Null>;

    users<T extends UserFindManyArgs = {}>(
      args?: Subset<T, UserFindManyArgs>,
    ): PrismaPromise<Array<UserGetPayload<T>> | Null>;

    Role_Company<T extends Role_CompanyFindManyArgs = {}>(
      args?: Subset<T, Role_CompanyFindManyArgs>,
    ): PrismaPromise<Array<Role_CompanyGetPayload<T>> | Null>;
   ...
   */
  export interface CompanyBranchFindUniqueArgs
    extends CompanyBranchFindUniqueArgsBase {
    /**
     * Throw an Error if query returns no results
     * @deprecated since 4.0.0: use `findUniqueOrThrow` method instead
     */
   ...
   */
  export interface CompanyBranchFindFirstArgs
    extends CompanyBranchFindFirstArgsBase {
    /**
     * Throw an Error if query returns no results
     * @deprecated since 4.0.0: use `findFirstOrThrow` method instead
     */
  ...
  export type CompanyBranchUpdateManyArgs = {
     ...
     **/
    data: XOR<
      CompanyBranchUpdateManyMutationInput,
      CompanyBranchUncheckedUpdateManyInput
    >;
    /**
  ...
  export type UserSelect = {
    ...
    Position_user?: boolean | Position_userFindManyArgs;
  ...
  export type UserGetPayload<S extends boolean | null | undefined | UserArgs> =
    S extends { select: any; include: any }
      ...
      ? User & {
          [P in TruthyKeys<S['include']>]: P extends 'profile'
            ? ProfileGetPayload<S['include'][P]> | null
            : P extends 'role'
            ? RoleGetPayload<S['include'][P]> | null
            : P extends 'company'
            ? Array<CompanyGetPayload<S['include'][P]>>
            : P extends 'companyBranch'
            ? CompanyBranchGetPayload<S['include'][P]> | null
            : P extends 'Role_Company'
            ? Role_CompanyGetPayload<S['include'][P]> | null
            : P extends 'Position_user'
            ? Array<Position_userGetPayload<S['include'][P]>>
            : P extends '_count'
      ...
      ? {
          [P in TruthyKeys<S['select']>]: P extends 'profile'
            ...
            : P extends 'companyBranch'
            ? CompanyBranchGetPayload<S['select'][P]> | null
            : P extends 'Role_Company'
            ? Role_CompanyGetPayload<S['select'][P]> | null
            : P extends 'Position_user'
            ? Array<Position_userGetPayload<S['select'][P]>>
            : P extends '_count'
  ...
  export class Prisma__UserClient<T, Null = never> implements PrismaPromise<T> {
    ...
    company<T extends CompanyFindManyArgs = {}>(
      args?: Subset<T, CompanyFindManyArgs>,
    ): PrismaPromise<Array<CompanyGetPayload<T>> | Null>;

    companyBranch<T extends CompanyBranchArgs = {}>(
      args?: Subset<T, CompanyBranchArgs>,
    ): Prisma__CompanyBranchClient<CompanyBranchGetPayload<T> | Null>;

    Role_Company<T extends Role_CompanyArgs = {}>(
      args?: Subset<T, Role_CompanyArgs>,
    ): Prisma__Role_CompanyClient<Role_CompanyGetPayload<T> | Null>;

    Position_user<T extends Position_userFindManyArgs = {}>(
      args?: Subset<T, Position_userFindManyArgs>,
    ): PrismaPromise<Array<Position_userGetPayload<T>> | Null>;
  ...
  export type RoleGetPayload<S extends boolean | null | undefined | RoleArgs> =
    S extends { select: any; include: any }
      ...
      ? Role & {
          [P in TruthyKeys<S['include']>]: P extends 'users'
            ? Array<UserGetPayload<S['include'][P]>>
            : P extends '_count'
  ...
  > {
    ...
    > extends True
      ...
      : Prisma__RoleClient<RoleGetPayload<T> | null, null>;
  ...
  export type GetRole_CompanyAggregateType<
    T extends Role_CompanyAggregateArgs,
  > = {
  ...
  type GetRole_CompanyGroupByPayload<T extends Role_CompanyGroupByArgs> =
    PrismaPromise<
      Array<
        PickArray<Role_CompanyGroupByOutputType, T['by']> & {
          [P in keyof T &
            keyof Role_CompanyGroupByOutputType]: P extends '_count'
            ? T[P] extends boolean
              ? number
  ...
  export type Role_CompanyGetPayload<
    S extends boolean | null | undefined | Role_CompanyArgs,
  > = S extends { select: any; include: any }
    ? 'Please either choose `select` or `include`'
    : S extends true
    ? Role_Company
    ...
    ? Role_Company & {
        [P in TruthyKeys<S['include']>]: P extends 'users'
          ...
          ? CompanyBranchGetPayload<S['include'][P]> | null
          : P extends '_count'
          ? Role_CompanyCountOutputTypeGetPayload<S['include'][P]>
          : never;
      }
    ...
    ? {
        [P in TruthyKeys<S['select']>]: P extends 'users'
          ...
          ? CompanyBranchGetPayload<S['select'][P]> | null
          : P extends '_count'
          ? Role_CompanyCountOutputTypeGetPayload<S['select'][P]>
          : P extends keyof Role_Company
          ? Role_Company[P]
          : never;
      }
    : Role_Company;
  ...
  export interface Role_CompanyDelegate<
    GlobalRejectSettings extends
      | Prisma.RejectOnNotFound
      | Prisma.RejectPerOperation
      | false
  ...
  > {
     ...
     **/
    findUnique<
      T extends Role_CompanyFindUniqueArgs,
      LocalRejectSettings = T['rejectOnNotFound'] extends RejectOnNotFound
        ? T['rejectOnNotFound']
        : undefined,
    >(
    ...
    > extends True
      ...
      : Prisma__Role_CompanyClient<Role_CompanyGetPayload<T> | null, null>;
     ...
     **/
    findFirst<
      T extends Role_CompanyFindFirstArgs,
      LocalRejectSettings = T['rejectOnNotFound'] extends RejectOnNotFound
        ? T['rejectOnNotFound']
        : undefined,
    >(
     ...
     * })
     **/
    aggregate<T extends Role_CompanyAggregateArgs>(
      args: Subset<T, Role_CompanyAggregateArgs>,
    ): PrismaPromise<GetRole_CompanyAggregateType<T>>;
    ...
    >(
      args: SubsetIntersection<T, Role_CompanyGroupByArgs, OrderByArg> &
        InputErrors,
    ): {} extends InputErrors
      ? GetRole_CompanyGroupByPayload<T>
      : PrismaPromise<InputErrors>;
  }
   ...
   * https://github.com/prisma/prisma-client-js/issues/707
   */
  export class Prisma__Role_CompanyClient<T, Null = never>
    implements PrismaPromise<T>
  {
    [prisma]: true;
    private readonly _dmmf;
   ...
   */
  export interface Role_CompanyFindUniqueArgs
    extends Role_CompanyFindUniqueArgsBase {
    /**
     * Throw an Error if query returns no results
     * @deprecated since 4.0.0: use `findUniqueOrThrow` method instead
     */
   ...
   */
  export interface Role_CompanyFindFirstArgs
    extends Role_CompanyFindFirstArgsBase {
    /**
     * Throw an Error if query returns no results
     * @deprecated since 4.0.0: use `findFirstOrThrow` method instead
     */
  ...
  export type Role_CompanyUpdateManyArgs = {
     ...
     **/
    data: XOR<
      Role_CompanyUpdateManyMutationInput,
      Role_CompanyUncheckedUpdateManyInput
    >;
    /**
  ...
  > = S extends { select: any; include: any }
    ...
    ? Province & {
        [P in TruthyKeys<S['include']>]: P extends 'district'
          ? Array<DistrictGetPayload<S['include'][P]>>
          : P extends '_count'
          ? ProvinceCountOutputTypeGetPayload<S['include'][P]>
          : never;
      }
    : S extends { select: any } & (ProvinceArgs | ProvinceFindManyArgs)
    ? {
        [P in TruthyKeys<S['select']>]: P extends 'district'
          ? Array<DistrictGetPayload<S['select'][P]>>
          : P extends '_count'
          ? ProvinceCountOutputTypeGetPayload<S['select'][P]>
          : P extends keyof Province
          ? Province[P]
          : never;
      }
    : Province;
  ...
  > {
     ...
     **/
    findUnique<
      T extends ProvinceFindUniqueArgs,
      LocalRejectSettings = T['rejectOnNotFound'] extends RejectOnNotFound
        ? T['rejectOnNotFound']
        : undefined,
    >(
    ...
    > extends True
      ...
      : Prisma__ProvinceClient<ProvinceGetPayload<T> | null, null>;
     ...
     **/
    findFirst<
      T extends ProvinceFindFirstArgs,
      LocalRejectSettings = T['rejectOnNotFound'] extends RejectOnNotFound
        ? T['rejectOnNotFound']
        : undefined,
    >(
    ...
    ): PrismaPromise<GetProvinceAggregateType<T>>;
    ...
    >(
      args: SubsetIntersection<T, ProvinceGroupByArgs, OrderByArg> &
        InputErrors,
    ): {} extends InputErrors
   ...
   * https://github.com/prisma/prisma-client-js/issues/707
   */
  export class Prisma__ProvinceClient<T, Null = never>
    implements PrismaPromise<T>
  {
    [prisma]: true;
    private readonly _dmmf;
    ...
    district<T extends DistrictFindManyArgs = {}>(
      args?: Subset<T, DistrictFindManyArgs>,
    ): PrismaPromise<Array<DistrictGetPayload<T>> | Null>;
  ...
  export type DistrictGetPayload<
    S extends boolean | null | undefined | DistrictArgs,
  > = S extends { select: any; include: any }
    ? 'Please either choose `select` or `include`'
    : S extends true
    ? District
    ...
    ? District & {
        [P in TruthyKeys<S['include']>]: P extends 'province'
          ? ProvinceGetPayload<S['include'][P]>
          : P extends 'amphoe'
          ? Array<AmphoeGetPayload<S['include'][P]>>
          : P extends '_count'
          ? DistrictCountOutputTypeGetPayload<S['include'][P]>
          : never;
      }
    : S extends { select: any } & (DistrictArgs | DistrictFindManyArgs)
    ? {
        [P in TruthyKeys<S['select']>]: P extends 'province'
          ? ProvinceGetPayload<S['select'][P]>
          : P extends 'amphoe'
          ? Array<AmphoeGetPayload<S['select'][P]>>
          : P extends '_count'
          ? DistrictCountOutputTypeGetPayload<S['select'][P]>
          : P extends keyof District
          ? District[P]
          : never;
      }
    : District;
  ...
  export interface DistrictDelegate<
    GlobalRejectSettings extends
      | Prisma.RejectOnNotFound
      | Prisma.RejectPerOperation
      | false
  ...
  > {
     ...
     **/
    findUnique<
      T extends DistrictFindUniqueArgs,
      LocalRejectSettings = T['rejectOnNotFound'] extends RejectOnNotFound
        ? T['rejectOnNotFound']
        : undefined,
    >(
    ...
    > extends True
      ...
      : Prisma__DistrictClient<DistrictGetPayload<T> | null, null>;
     ...
     **/
    findFirst<
      T extends DistrictFindFirstArgs,
      LocalRejectSettings = T['rejectOnNotFound'] extends RejectOnNotFound
        ? T['rejectOnNotFound']
        : undefined,
    >(
     ...
     * })
     **/
    aggregate<T extends DistrictAggregateArgs>(
      args: Subset<T, DistrictAggregateArgs>,
    ): PrismaPromise<GetDistrictAggregateType<T>>;
    ...
    >(
      args: SubsetIntersection<T, DistrictGroupByArgs, OrderByArg> &
        InputErrors,
    ): {} extends InputErrors
      ? GetDistrictGroupByPayload<T>
      : PrismaPromise<InputErrors>;
  }
   ...
   * https://github.com/prisma/prisma-client-js/issues/707
   */
  export class Prisma__DistrictClient<T, Null = never>
    implements PrismaPromise<T>
  {
    [prisma]: true;
    private readonly _dmmf;
    ...
    province<T extends ProvinceArgs = {}>(
      args?: Subset<T, ProvinceArgs>,
    ): Prisma__ProvinceClient<ProvinceGetPayload<T> | Null>;

    amphoe<T extends AmphoeFindManyArgs = {}>(
      args?: Subset<T, AmphoeFindManyArgs>,
    ): PrismaPromise<Array<AmphoeGetPayload<T>> | Null>;
  ...
  export type AmphoeGetPayload<
    S extends boolean | null | undefined | AmphoeArgs,
  > = S extends { select: any; include: any }
    ? 'Please either choose `select` or `include`'
    : S extends true
    ? Amphoe
    ...
    ? Amphoe & {
        [P in TruthyKeys<S['include']>]: P extends 'district'
          ? DistrictGetPayload<S['include'][P]>
          : never;
      }
    : S extends { select: any } & (AmphoeArgs | AmphoeFindManyArgs)
    ? {
        [P in TruthyKeys<S['select']>]: P extends 'district'
          ? DistrictGetPayload<S['select'][P]>
          : P extends keyof Amphoe
          ? Amphoe[P]
          : never;
      }
    : Amphoe;
  ...
  export interface AmphoeDelegate<
    GlobalRejectSettings extends
      | Prisma.RejectOnNotFound
      | Prisma.RejectPerOperation
      | false
  ...
  > {
     ...
     **/
    findUnique<
      T extends AmphoeFindUniqueArgs,
      LocalRejectSettings = T['rejectOnNotFound'] extends RejectOnNotFound
        ? T['rejectOnNotFound']
        : undefined,
    >(
    ...
    > extends True
      ...
      : Prisma__AmphoeClient<AmphoeGetPayload<T> | null, null>;
     ...
     * })
     **/
    aggregate<T extends AmphoeAggregateArgs>(
      args: Subset<T, AmphoeAggregateArgs>,
    ): PrismaPromise<GetAmphoeAggregateType<T>>;
    ...
    >(
      args: SubsetIntersection<T, AmphoeGroupByArgs, OrderByArg> & InputErrors,
    ): {} extends InputErrors
      ? GetAmphoeGroupByPayload<T>
      : PrismaPromise<InputErrors>;
  }
   ...
   * https://github.com/prisma/prisma-client-js/issues/707
   */
  export class Prisma__AmphoeClient<T, Null = never>
    implements PrismaPromise<T>
  {
    [prisma]: true;
    private readonly _dmmf;
    ...
    district<T extends DistrictArgs = {}>(
      args?: Subset<T, DistrictArgs>,
    ): Prisma__DistrictClient<DistrictGetPayload<T> | Null>;
  ...
  export type GetMas_positionAggregateType<
    T extends Mas_positionAggregateArgs,
  > = {
  ...
  type GetMas_positionGroupByPayload<T extends Mas_positionGroupByArgs> =
    PrismaPromise<
      Array<
        PickArray<Mas_positionGroupByOutputType, T['by']> & {
          [P in keyof T &
            keyof Mas_positionGroupByOutputType]: P extends '_count'
            ? T[P] extends boolean
              ? number
  ...
  export type mas_positionGetPayload<
    S extends boolean | null | undefined | mas_positionArgs,
  > = S extends { select: any; include: any }
    ? 'Please either choose `select` or `include`'
    : S extends true
    ? mas_position
    ...
    ? mas_position & {
        [P in TruthyKeys<S['include']>]: P extends 'mas_positionlevel1'
          ? Array<mas_positionlevel1GetPayload<S['include'][P]>>
          : P extends 'mas_positionlevel2'
          ? Array<mas_positionlevel2GetPayload<S['include'][P]>>
          : P extends 'mas_positionlevel3'
          ...
          ? CompanyGetPayload<S['include'][P]> | null
          : P extends '_count'
          ? Mas_positionCountOutputTypeGetPayload<S['include'][P]>
          : never;
      }
    : S extends { select: any } & (mas_positionArgs | mas_positionFindManyArgs)
    ? {
        [P in TruthyKeys<S['select']>]: P extends 'mas_positionlevel1'
          ? Array<mas_positionlevel1GetPayload<S['select'][P]>>
          : P extends 'mas_positionlevel2'
          ? Array<mas_positionlevel2GetPayload<S['select'][P]>>
          : P extends 'mas_positionlevel3'
          ...
          ? CompanyGetPayload<S['select'][P]> | null
          : P extends '_count'
          ? Mas_positionCountOutputTypeGetPayload<S['select'][P]>
          : P extends keyof mas_position
          ? mas_position[P]
          : never;
      }
    : mas_position;

  type mas_positionCountArgs = Omit<
    mas_positionFindManyArgs,
    'select' | 'include'
  > & {
    select?: Mas_positionCountAggregateInputType | true;
  };

  export interface mas_positionDelegate<
    GlobalRejectSettings extends
      | Prisma.RejectOnNotFound
      | Prisma.RejectPerOperation
      | false
  ...
  > {
     ...
     **/
    findUnique<
      T extends mas_positionFindUniqueArgs,
      LocalRejectSettings = T['rejectOnNotFound'] extends RejectOnNotFound
        ? T['rejectOnNotFound']
        : undefined,
    >(
    ...
    > extends True
      ...
      : Prisma__mas_positionClient<mas_positionGetPayload<T> | null, null>;
     ...
     **/
    findFirst<
      T extends mas_positionFindFirstArgs,
      LocalRejectSettings = T['rejectOnNotFound'] extends RejectOnNotFound
        ? T['rejectOnNotFound']
        : undefined,
    >(
     ...
     * })
     **/
    aggregate<T extends Mas_positionAggregateArgs>(
      args: Subset<T, Mas_positionAggregateArgs>,
    ): PrismaPromise<GetMas_positionAggregateType<T>>;
    ...
    >(
      args: SubsetIntersection<T, Mas_positionGroupByArgs, OrderByArg> &
        InputErrors,
    ): {} extends InputErrors
      ? GetMas_positionGroupByPayload<T>
      : PrismaPromise<InputErrors>;
  }
   ...
   * https://github.com/prisma/prisma-client-js/issues/707
   */
  export class Prisma__mas_positionClient<T, Null = never>
    implements PrismaPromise<T>
  {
    [prisma]: true;
    private readonly _dmmf;
    ...
    mas_positionlevel1<T extends mas_position$mas_positionlevel1Args = {}>(
      args?: Subset<T, mas_position$mas_positionlevel1Args>,
    ): PrismaPromise<Array<mas_positionlevel1GetPayload<T>> | Null>;

    mas_positionlevel2<T extends mas_position$mas_positionlevel2Args = {}>(
      args?: Subset<T, mas_position$mas_positionlevel2Args>,
    ): PrismaPromise<Array<mas_positionlevel2GetPayload<T>> | Null>;

    mas_positionlevel3<T extends mas_position$mas_positionlevel3Args = {}>(
      args?: Subset<T, mas_position$mas_positionlevel3Args>,
    ): PrismaPromise<Array<mas_positionlevel3GetPayload<T>> | Null>;
   ...
   */
  export interface mas_positionFindUniqueArgs
    extends mas_positionFindUniqueArgsBase {
    /**
     * Throw an Error if query returns no results
     * @deprecated since 4.0.0: use `findUniqueOrThrow` method instead
     */
   ...
   */
  export interface mas_positionFindFirstArgs
    extends mas_positionFindFirstArgsBase {
    /**
     * Throw an Error if query returns no results
     * @deprecated since 4.0.0: use `findFirstOrThrow` method instead
     */
  ...
  export type mas_positionUpdateManyArgs = {
     ...
     */
    data: XOR<
      mas_positionUpdateManyMutationInput,
      mas_positionUncheckedUpdateManyInput
    >;
    /**
  ...
  export type GetMas_positionlevel1AggregateType<
    T extends Mas_positionlevel1AggregateArgs,
  > = {
    [P in keyof T & keyof AggregateMas_positionlevel1]: P extends
      | '_count'
      | 'count'
      ? T[P] extends true
        ? number
  ...
  export type Mas_positionlevel1GroupByArgs = {
    ...
    by: Array<Mas_positionlevel1ScalarFieldEnum>;
  ...
  type GetMas_positionlevel1GroupByPayload<
    T extends Mas_positionlevel1GroupByArgs,
  > = PrismaPromise<
    Array<
      PickArray<Mas_positionlevel1GroupByOutputType, T['by']> & {
        [P in keyof T &
          keyof Mas_positionlevel1GroupByOutputType]: P extends '_count'
          ? T[P] extends boolean
            ? number
  ...
  export type mas_positionlevel1GetPayload<
    S extends boolean | null | undefined | mas_positionlevel1Args,
  > = S extends { select: any; include: any }
    ? 'Please either choose `select` or `include`'
    : S extends true
    ? mas_positionlevel1
    ...
    ? never
    : S extends { include: any } & (
        | mas_positionlevel1Args
        | mas_positionlevel1FindManyArgs
      )
    ? mas_positionlevel1 & {
        [P in TruthyKeys<S['include']>]: P extends 'mas_position'
          ? mas_positionGetPayload<S['include'][P]> | null
          : P extends 'mas_positionlevel2'
          ? Array<mas_positionlevel2GetPayload<S['include'][P]>>
          : P extends 'Company'
          ? CompanyGetPayload<S['include'][P]> | null
          ...
          ? Array<Position_userGetPayload<S['include'][P]>>
          : P extends '_count'
          ? Mas_positionlevel1CountOutputTypeGetPayload<S['include'][P]>
          : never;
      }
    : S extends { select: any } & (
        | mas_positionlevel1Args
    ...
    ? {
        [P in TruthyKeys<S['select']>]: P extends 'mas_position'
          ? mas_positionGetPayload<S['select'][P]> | null
          : P extends 'mas_positionlevel2'
          ? Array<mas_positionlevel2GetPayload<S['select'][P]>>
          : P extends 'Company'
          ? CompanyGetPayload<S['select'][P]> | null
          ...
          ? Array<Position_userGetPayload<S['select'][P]>>
          : P extends '_count'
          ? Mas_positionlevel1CountOutputTypeGetPayload<S['select'][P]>
          : P extends keyof mas_positionlevel1
          ? mas_positionlevel1[P]
          : never;
      }
    : mas_positionlevel1;

  type mas_positionlevel1CountArgs = Merge<
    Omit<mas_positionlevel1FindManyArgs, 'select' | 'include'> & {
      select?: Mas_positionlevel1CountAggregateInputType | true;
    }
  >;

  export interface mas_positionlevel1Delegate<
    GlobalRejectSettings extends
      | Prisma.RejectOnNotFound
      | Prisma.RejectPerOperation
      | false
  ...
  > {
     ...
     **/
    findUnique<
      T extends mas_positionlevel1FindUniqueArgs,
      LocalRejectSettings = T['rejectOnNotFound'] extends RejectOnNotFound
        ? T['rejectOnNotFound']
        : undefined,
    >(
    ...
    > extends True
      ...
      : Prisma__mas_positionlevel1Client<
          mas_positionlevel1GetPayload<T> | null,
          null
        >;
     ...
     **/
    findFirst<
      T extends mas_positionlevel1FindFirstArgs,
      LocalRejectSettings = T['rejectOnNotFound'] extends RejectOnNotFound
        ? T['rejectOnNotFound']
        : undefined,
    >(
    ...
    count<T extends mas_positionlevel1CountArgs>(
      ...
      T extends _Record<'select', any>
        ? T['select'] extends true
          ...
          : GetScalarType<
              T['select'],
              Mas_positionlevel1CountAggregateOutputType
            >
        : number
    >;
     ...
     * })
     **/
    aggregate<T extends Mas_positionlevel1AggregateArgs>(
      args: Subset<T, Mas_positionlevel1AggregateArgs>,
    ): PrismaPromise<GetMas_positionlevel1AggregateType<T>>;
    ...
    >(
      args: SubsetIntersection<T, Mas_positionlevel1GroupByArgs, OrderByArg> &
        InputErrors,
    ): {} extends InputErrors
      ? GetMas_positionlevel1GroupByPayload<T>
      : PrismaPromise<InputErrors>;
  }
   ...
   * https://github.com/prisma/prisma-client-js/issues/707
   */
  export class Prisma__mas_positionlevel1Client<T, Null = never>
    implements PrismaPromise<T>
  {
    [prisma]: true;
    private readonly _dmmf;
    ...
    mas_position<T extends mas_positionArgs = {}>(
      args?: Subset<T, mas_positionArgs>,
    ): Prisma__mas_positionClient<mas_positionGetPayload<T> | Null>;
   ...
   */
  export interface mas_positionlevel1FindUniqueArgs
    extends mas_positionlevel1FindUniqueArgsBase {
    /**
     * Throw an Error if query returns no results
     * @deprecated since 4.0.0: use `findUniqueOrThrow` method instead
     */
   ...
   */
  export interface mas_positionlevel1FindFirstArgs
    extends mas_positionlevel1FindFirstArgsBase {
    /**
     * Throw an Error if query returns no results
     * @deprecated since 4.0.0: use `findFirstOrThrow` method instead
     */
  ...
  export type mas_positionlevel1CreateArgs = {
     ...
     **/
    data: XOR<
      mas_positionlevel1CreateInput,
      mas_positionlevel1UncheckedCreateInput
    >;
  };
  ...
  export type mas_positionlevel1UpdateArgs = {
     ...
     **/
    data: XOR<
      mas_positionlevel1UpdateInput,
      mas_positionlevel1UncheckedUpdateInput
    >;
    /**
  ...
  export type mas_positionlevel1UpdateManyArgs = {
     ...
     **/
    data: XOR<
      mas_positionlevel1UpdateManyMutationInput,
      mas_positionlevel1UncheckedUpdateManyInput
    >;
    /**
  ...
  export type GetMas_positionlevel2AggregateType<
    T extends Mas_positionlevel2AggregateArgs,
  > = {
    [P in keyof T & keyof AggregateMas_positionlevel2]: P extends
      | '_count'
      | 'count'
      ? T[P] extends true
        ? number
  ...
  export type Mas_positionlevel2GroupByArgs = {
    ...
    by: Array<Mas_positionlevel2ScalarFieldEnum>;
  ...
  type GetMas_positionlevel2GroupByPayload<
    T extends Mas_positionlevel2GroupByArgs,
  > = PrismaPromise<
    Array<
      PickArray<Mas_positionlevel2GroupByOutputType, T['by']> & {
        [P in keyof T &
          keyof Mas_positionlevel2GroupByOutputType]: P extends '_count'
          ? T[P] extends boolean
            ? number
  ...
  export type mas_positionlevel2Select = {
    ...
    mas_positionlevel3?: boolean | mas_positionlevel3FindManyArgs;
    Company?: boolean | CompanyArgs;
  ...
  export type mas_positionlevel2GetPayload<
    S extends boolean | null | undefined | mas_positionlevel2Args,
  > = S extends { select: any; include: any }
    ? 'Please either choose `select` or `include`'
    : S extends true
    ? mas_positionlevel2
    ...
    ? never
    : S extends { include: any } & (
        | mas_positionlevel2Args
        | mas_positionlevel2FindManyArgs
      )
    ? mas_positionlevel2 & {
        [P in TruthyKeys<S['include']>]: P extends 'mas_positionlevel1'
          ? mas_positionlevel1GetPayload<S['include'][P]> | null
          : P extends 'mas_positionlevel3'
          ? Array<mas_positionlevel3GetPayload<S['include'][P]>>
          : P extends 'Company'
          ? CompanyGetPayload<S['include'][P]> | null
          ...
          ? Array<Position_userGetPayload<S['include'][P]>>
          : P extends '_count'
          ? Mas_positionlevel2CountOutputTypeGetPayload<S['include'][P]>
          : never;
      }
    : S extends { select: any } & (
        | mas_positionlevel2Args
    ...
    ? {
        [P in TruthyKeys<S['select']>]: P extends 'mas_positionlevel1'
          ? mas_positionlevel1GetPayload<S['select'][P]> | null
          : P extends 'mas_positionlevel3'
          ? Array<mas_positionlevel3GetPayload<S['select'][P]>>
          : P extends 'Company'
          ? CompanyGetPayload<S['select'][P]> | null
          ...
          ? Array<Position_userGetPayload<S['select'][P]>>
          : P extends '_count'
          ? Mas_positionlevel2CountOutputTypeGetPayload<S['select'][P]>
          : P extends keyof mas_positionlevel2
          ? mas_positionlevel2[P]
          : never;
      }
    : mas_positionlevel2;

  type mas_positionlevel2CountArgs = Merge<
    Omit<mas_positionlevel2FindManyArgs, 'select' | 'include'> & {
      select?: Mas_positionlevel2CountAggregateInputType | true;
    }
  >;

  export interface mas_positionlevel2Delegate<
    GlobalRejectSettings extends
      | Prisma.RejectOnNotFound
      | Prisma.RejectPerOperation
      | false
  ...
  > {
     ...
     **/
    findUnique<
      T extends mas_positionlevel2FindUniqueArgs,
      LocalRejectSettings = T['rejectOnNotFound'] extends RejectOnNotFound
        ? T['rejectOnNotFound']
        : undefined,
    >(
    ...
    > extends True
      ...
      : Prisma__mas_positionlevel2Client<
          mas_positionlevel2GetPayload<T> | null,
          null
        >;
     ...
     **/
    findFirst<
      T extends mas_positionlevel2FindFirstArgs,
      LocalRejectSettings = T['rejectOnNotFound'] extends RejectOnNotFound
        ? T['rejectOnNotFound']
        : undefined,
    >(
    ...
    count<T extends mas_positionlevel2CountArgs>(
      ...
      T extends _Record<'select', any>
        ? T['select'] extends true
          ...
          : GetScalarType<
              T['select'],
              Mas_positionlevel2CountAggregateOutputType
            >
        : number
    >;
     ...
     * })
     **/
    aggregate<T extends Mas_positionlevel2AggregateArgs>(
      args: Subset<T, Mas_positionlevel2AggregateArgs>,
    ): PrismaPromise<GetMas_positionlevel2AggregateType<T>>;
    ...
    >(
      args: SubsetIntersection<T, Mas_positionlevel2GroupByArgs, OrderByArg> &
        InputErrors,
    ): {} extends InputErrors
      ? GetMas_positionlevel2GroupByPayload<T>
      : PrismaPromise<InputErrors>;
  }
   ...
   * https://github.com/prisma/prisma-client-js/issues/707
   */
  export class Prisma__mas_positionlevel2Client<T, Null = never>
    implements PrismaPromise<T>
  {
    [prisma]: true;
    private readonly _dmmf;
    ...
    mas_positionlevel1<T extends mas_positionlevel1Args = {}>(
      args?: Subset<T, mas_positionlevel1Args>,
    ): Prisma__mas_positionlevel1Client<mas_positionlevel1GetPayload<T> | Null>;
   ...
   */
  export interface mas_positionlevel2FindUniqueArgs
    extends mas_positionlevel2FindUniqueArgsBase {
    /**
     * Throw an Error if query returns no results
     * @deprecated since 4.0.0: use `findUniqueOrThrow` method instead
     */
   ...
   */
  export interface mas_positionlevel2FindFirstArgs
    extends mas_positionlevel2FindFirstArgsBase {
    /**
     * Throw an Error if query returns no results
     * @deprecated since 4.0.0: use `findFirstOrThrow` method instead
     */
  ...
  export type mas_positionlevel2CreateArgs = {
     ...
     **/
    data: XOR<
      mas_positionlevel2CreateInput,
      mas_positionlevel2UncheckedCreateInput
    >;
  };
  ...
  export type mas_positionlevel2UpdateArgs = {
     ...
     **/
    data: XOR<
      mas_positionlevel2UpdateInput,
      mas_positionlevel2UncheckedUpdateInput
    >;
    /**
  ...
  export type mas_positionlevel2UpdateManyArgs = {
     ...
     **/
    data: XOR<
      mas_positionlevel2UpdateManyMutationInput,
      mas_positionlevel2UncheckedUpdateManyInput
    >;
    /**
  ...
  export type GetMas_positionlevel3AggregateType<
    T extends Mas_positionlevel3AggregateArgs,
  > = {
    [P in keyof T & keyof AggregateMas_positionlevel3]: P extends
      | '_count'
      | 'count'
      ? T[P] extends true
        ? number
  ...
  export type Mas_positionlevel3GroupByArgs = {
    ...
    by: Array<Mas_positionlevel3ScalarFieldEnum>;
  ...
  type GetMas_positionlevel3GroupByPayload<
    T extends Mas_positionlevel3GroupByArgs,
  > = PrismaPromise<
    Array<
      PickArray<Mas_positionlevel3GroupByOutputType, T['by']> & {
        [P in keyof T &
          keyof Mas_positionlevel3GroupByOutputType]: P extends '_count'
          ? T[P] extends boolean
            ? number
  ...
  export type mas_positionlevel3GetPayload<
    S extends boolean | null | undefined | mas_positionlevel3Args,
  > = S extends { select: any; include: any }
    ? 'Please either choose `select` or `include`'
    : S extends true
    ? mas_positionlevel3
    ...
    ? never
    : S extends { include: any } & (
        | mas_positionlevel3Args
        | mas_positionlevel3FindManyArgs
      )
    ? mas_positionlevel3 & {
        [P in TruthyKeys<S['include']>]: P extends 'mas_positionlevel2'
          ? mas_positionlevel2GetPayload<S['include'][P]> | null
          : P extends 'mas_position'
          ? mas_positionGetPayload<S['include'][P]> | null
          : P extends 'Company'
          ? CompanyGetPayload<S['include'][P]> | null
          ...
          ? Array<Position_userGetPayload<S['include'][P]>>
          : P extends '_count'
          ? Mas_positionlevel3CountOutputTypeGetPayload<S['include'][P]>
          : never;
      }
    : S extends { select: any } & (
        | mas_positionlevel3Args
    ...
    ? {
        [P in TruthyKeys<S['select']>]: P extends 'mas_positionlevel2'
          ? mas_positionlevel2GetPayload<S['select'][P]> | null
          : P extends 'mas_position'
          ? mas_positionGetPayload<S['select'][P]> | null
          : P extends 'Company'
          ? CompanyGetPayload<S['select'][P]> | null
          ...
          ? Array<Position_userGetPayload<S['select'][P]>>
          : P extends '_count'
          ? Mas_positionlevel3CountOutputTypeGetPayload<S['select'][P]>
          : P extends keyof mas_positionlevel3
          ? mas_positionlevel3[P]
          : never;
      }
    : mas_positionlevel3;

  type mas_positionlevel3CountArgs = Merge<
    Omit<mas_positionlevel3FindManyArgs, 'select' | 'include'> & {
      select?: Mas_positionlevel3CountAggregateInputType | true;
    }
  >;

  export interface mas_positionlevel3Delegate<
    GlobalRejectSettings extends
      | Prisma.RejectOnNotFound
      | Prisma.RejectPerOperation
      | false
  ...
  > {
     ...
     **/
    findUnique<
      T extends mas_positionlevel3FindUniqueArgs,
      LocalRejectSettings = T['rejectOnNotFound'] extends RejectOnNotFound
        ? T['rejectOnNotFound']
        : undefined,
    >(
    ...
    > extends True
      ...
      : Prisma__mas_positionlevel3Client<
          mas_positionlevel3GetPayload<T> | null,
          null
        >;
     ...
     **/
    findFirst<
      T extends mas_positionlevel3FindFirstArgs,
      LocalRejectSettings = T['rejectOnNotFound'] extends RejectOnNotFound
        ? T['rejectOnNotFound']
        : undefined,
    >(
    ...
    count<T extends mas_positionlevel3CountArgs>(
      ...
      T extends _Record<'select', any>
        ? T['select'] extends true
          ...
          : GetScalarType<
              T['select'],
              Mas_positionlevel3CountAggregateOutputType
            >
        : number
    >;
     ...
     * })
     **/
    aggregate<T extends Mas_positionlevel3AggregateArgs>(
      args: Subset<T, Mas_positionlevel3AggregateArgs>,
    ): PrismaPromise<GetMas_positionlevel3AggregateType<T>>;
    ...
    >(
      args: SubsetIntersection<T, Mas_positionlevel3GroupByArgs, OrderByArg> &
        InputErrors,
    ): {} extends InputErrors
      ? GetMas_positionlevel3GroupByPayload<T>
      : PrismaPromise<InputErrors>;
  }
   ...
   * https://github.com/prisma/prisma-client-js/issues/707
   */
  export class Prisma__mas_positionlevel3Client<T, Null = never>
    implements PrismaPromise<T>
  {
    [prisma]: true;
    private readonly _dmmf;
    ...
    mas_positionlevel2<T extends mas_positionlevel2Args = {}>(
      args?: Subset<T, mas_positionlevel2Args>,
    ): Prisma__mas_positionlevel2Client<mas_positionlevel2GetPayload<T> | Null>;
   ...
   */
  export interface mas_positionlevel3FindUniqueArgs
    extends mas_positionlevel3FindUniqueArgsBase {
    /**
     * Throw an Error if query returns no results
     * @deprecated since 4.0.0: use `findUniqueOrThrow` method instead
     */
   ...
   */
  export interface mas_positionlevel3FindFirstArgs
    extends mas_positionlevel3FindFirstArgsBase {
    /**
     * Throw an Error if query returns no results
     * @deprecated since 4.0.0: use `findFirstOrThrow` method instead
     */
  ...
  export type mas_positionlevel3CreateArgs = {
     ...
     **/
    data: XOR<
      mas_positionlevel3CreateInput,
      mas_positionlevel3UncheckedCreateInput
    >;
  };
  ...
  export type mas_positionlevel3UpdateArgs = {
     ...
     **/
    data: XOR<
      mas_positionlevel3UpdateInput,
      mas_positionlevel3UncheckedUpdateInput
    >;
    /**
  ...
  export type mas_positionlevel3UpdateManyArgs = {
     ...
     **/
    data: XOR<
      mas_positionlevel3UpdateManyMutationInput,
      mas_positionlevel3UncheckedUpdateManyInput
    >;
    /**
  ...
  export type GetPosition_userAggregateType<
    T extends Position_userAggregateArgs,
  > = {
  ...
  export type Position_userGroupByArgs = {
    ...
    by: Array<Position_userScalarFieldEnum>;
  ...
  type GetPosition_userGroupByPayload<T extends Position_userGroupByArgs> =
    PrismaPromise<
      Array<
        PickArray<Position_userGroupByOutputType, T['by']> & {
          [P in keyof T &
            keyof Position_userGroupByOutputType]: P extends '_count'
            ? T[P] extends boolean
              ? number
  ...
  export type Position_userGetPayload<
    S extends boolean | null | undefined | Position_userArgs,
  > = S extends { select: any; include: any }
    ? 'Please either choose `select` or `include`'
    : S extends true
    ? Position_user
    ...
    ? Position_user & {
        [P in TruthyKeys<S['include']>]: P extends 'user'
          ...
          ? mas_positionlevel2GetPayload<S['include'][P]> | null
          : P extends 'mas_positionlevel3'
          ? mas_positionlevel3GetPayload<S['include'][P]> | null
          : never;
      }
    : S extends { select: any } & (
        | Position_userArgs
    ...
    ? {
        [P in TruthyKeys<S['select']>]: P extends 'user'
          ...
          ? mas_positionlevel2GetPayload<S['select'][P]> | null
          : P extends 'mas_positionlevel3'
          ? mas_positionlevel3GetPayload<S['select'][P]> | null
          : P extends keyof Position_user
          ? Position_user[P]
          : never;
      }
    : Position_user;

  type Position_userCountArgs = Merge<
    Omit<Position_userFindManyArgs, 'select' | 'include'> & {
      select?: Position_userCountAggregateInputType | true;
    }
  >;

  export interface Position_userDelegate<
    GlobalRejectSettings extends
      | Prisma.RejectOnNotFound
      | Prisma.RejectPerOperation
      | false
  ...
  > {
     ...
     **/
    findUnique<
      T extends Position_userFindUniqueArgs,
      LocalRejectSettings = T['rejectOnNotFound'] extends RejectOnNotFound
        ? T['rejectOnNotFound']
        : undefined,
    >(
    ...
    > extends True
      ...
      : Prisma__Position_userClient<Position_userGetPayload<T> | null, null>;
     ...
     **/
    findFirst<
      T extends Position_userFindFirstArgs,
      LocalRejectSettings = T['rejectOnNotFound'] extends RejectOnNotFound
        ? T['rejectOnNotFound']
        : undefined,
    >(
     ...
     * })
     **/
    aggregate<T extends Position_userAggregateArgs>(
      args: Subset<T, Position_userAggregateArgs>,
    ): PrismaPromise<GetPosition_userAggregateType<T>>;
    ...
    >(
      args: SubsetIntersection<T, Position_userGroupByArgs, OrderByArg> &
        InputErrors,
    ): {} extends InputErrors
      ? GetPosition_userGroupByPayload<T>
      : PrismaPromise<InputErrors>;
  }
   ...
   * https://github.com/prisma/prisma-client-js/issues/707
   */
  export class Prisma__Position_userClient<T, Null = never>
    implements PrismaPromise<T>
  {
    [prisma]: true;
    private readonly _dmmf;
    ...
    mas_positionlevel3<T extends mas_positionlevel3Args = {}>(
      args?: Subset<T, mas_positionlevel3Args>,
    ): Prisma__mas_positionlevel3Client<mas_positionlevel3GetPayload<T> | Null>;
   ...
   */
  export interface Position_userFindUniqueArgs
    extends Position_userFindUniqueArgsBase {
    /**
     * Throw an Error if query returns no results
     * @deprecated since 4.0.0: use `findUniqueOrThrow` method instead
     */
   ...
   */
  export interface Position_userFindFirstArgs
    extends Position_userFindFirstArgsBase {
    /**
     * Throw an Error if query returns no results
     * @deprecated since 4.0.0: use `findFirstOrThrow` method instead
     */
  ...
  export type Position_userUpdateManyArgs = {
     ...
     **/
    data: XOR<
      Position_userUpdateManyMutationInput,
      Position_userUncheckedUpdateManyInput
    >;
    /**
  ...
  export type GetHoliday_dateAggregateType<
    T extends Holiday_dateAggregateArgs,
  > = {
  ...
  export type Holiday_dateGroupByArgs = {
    ...
    by: Array<Holiday_dateScalarFieldEnum>;
  ...
  type GetHoliday_dateGroupByPayload<T extends Holiday_dateGroupByArgs> =
    PrismaPromise<
      Array<
        PickArray<Holiday_dateGroupByOutputType, T['by']> & {
          [P in keyof T &
            keyof Holiday_dateGroupByOutputType]: P extends '_count'
            ? T[P] extends boolean
              ? number
  ...
  export type holiday_dateGetPayload<
    S extends boolean | null | undefined | holiday_dateArgs,
  > = S extends { select: any; include: any }
    ? 'Please either choose `select` or `include`'
    : S extends true
    ? holiday_date
    ...
    ? {
        [P in TruthyKeys<S['select']>]: P extends 'Company'
          ? CompanyGetPayload<S['select'][P]> | null
          : P extends keyof holiday_date
          ? holiday_date[P]
          : never;
      }
    : holiday_date;

  type holiday_dateCountArgs = Merge<
    Omit<holiday_dateFindManyArgs, 'select' | 'include'> & {
      select?: Holiday_dateCountAggregateInputType | true;
    }
  >;

  export interface holiday_dateDelegate<
    GlobalRejectSettings extends
      | Prisma.RejectOnNotFound
      | Prisma.RejectPerOperation
      | false
  ...
  > {
     ...
     **/
    findUnique<
      T extends holiday_dateFindUniqueArgs,
      LocalRejectSettings = T['rejectOnNotFound'] extends RejectOnNotFound
        ? T['rejectOnNotFound']
        : undefined,
    >(
    ...
    > extends True
      ...
      : Prisma__holiday_dateClient<holiday_dateGetPayload<T> | null, null>;
     ...
     **/
    findFirst<
      T extends holiday_dateFindFirstArgs,
      LocalRejectSettings = T['rejectOnNotFound'] extends RejectOnNotFound
        ? T['rejectOnNotFound']
        : undefined,
    >(
     ...
     * })
     **/
    aggregate<T extends Holiday_dateAggregateArgs>(
      args: Subset<T, Holiday_dateAggregateArgs>,
    ): PrismaPromise<GetHoliday_dateAggregateType<T>>;
    ...
    >(
      args: SubsetIntersection<T, Holiday_dateGroupByArgs, OrderByArg> &
        InputErrors,
    ): {} extends InputErrors
      ? GetHoliday_dateGroupByPayload<T>
      : PrismaPromise<InputErrors>;
  }
   ...
   * https://github.com/prisma/prisma-client-js/issues/707
   */
  export class Prisma__holiday_dateClient<T, Null = never>
    implements PrismaPromise<T>
  {
    [prisma]: true;
    private readonly _dmmf;
   ...
   */
  export interface holiday_dateFindUniqueArgs
    extends holiday_dateFindUniqueArgsBase {
    /**
     * Throw an Error if query returns no results
     * @deprecated since 4.0.0: use `findUniqueOrThrow` method instead
     */
   ...
   */
  export interface holiday_dateFindFirstArgs
    extends holiday_dateFindFirstArgsBase {
    /**
     * Throw an Error if query returns no results
     * @deprecated since 4.0.0: use `findFirstOrThrow` method instead
     */
  ...
  export type holiday_dateUpdateManyArgs = {
     ...
     **/
    data: XOR<
      holiday_dateUpdateManyMutationInput,
      holiday_dateUncheckedUpdateManyInput
    >;
    /**
  ...
  export type AmphoeScalarFieldEnum =
    (typeof AmphoeScalarFieldEnum)[keyof typeof AmphoeScalarFieldEnum];
  ...
  export type CompanyBranchScalarFieldEnum =
    (typeof CompanyBranchScalarFieldEnum)[keyof typeof CompanyBranchScalarFieldEnum];
  ...
  export type Holiday_dateScalarFieldEnum =
    (typeof Holiday_dateScalarFieldEnum)[keyof typeof Holiday_dateScalarFieldEnum];
  ...
  export type Holiday_yearScalarFieldEnum =
    (typeof Holiday_yearScalarFieldEnum)[keyof typeof Holiday_yearScalarFieldEnum];
  ...
  export type Mas_positionScalarFieldEnum =
    (typeof Mas_positionScalarFieldEnum)[keyof typeof Mas_positionScalarFieldEnum];
  ...
  export type Mas_positionlevel1ScalarFieldEnum =
    (typeof Mas_positionlevel1ScalarFieldEnum)[keyof typeof Mas_positionlevel1ScalarFieldEnum];
  ...
  export type Mas_positionlevel2ScalarFieldEnum =
    (typeof Mas_positionlevel2ScalarFieldEnum)[keyof typeof Mas_positionlevel2ScalarFieldEnum];
  ...
  export type Mas_positionlevel3ScalarFieldEnum =
    (typeof Mas_positionlevel3ScalarFieldEnum)[keyof typeof Mas_positionlevel3ScalarFieldEnum];
  ...
  export type Position_userScalarFieldEnum =
    (typeof Position_userScalarFieldEnum)[keyof typeof Position_userScalarFieldEnum];
  ...
  export type Role_CompanyScalarFieldEnum =
    (typeof Role_CompanyScalarFieldEnum)[keyof typeof Role_CompanyScalarFieldEnum];
  ...
  export type UserWhereInput = {
    ...
    companyBranch?: XOR<
      CompanyBranchRelationFilter,
      CompanyBranchWhereInput
    > | null;
    companyBranchId?: UuidNullableFilter | string | null;
    Role_Company?: XOR<
      Role_CompanyRelationFilter,
      Role_CompanyWhereInput
    > | null;
  ...
  export type mas_positionlevel1WhereInput = {
    ...
    mas_position?: XOR<
      Mas_positionRelationFilter,
      mas_positionWhereInput
    > | null;
    mas_positionlevel2?: Mas_positionlevel2ListRelationFilter;
    Company?: XOR<CompanyRelationFilter, CompanyWhereInput> | null;
    CompanyId?: UuidNullableFilter | string | null;
  ...
  export type mas_positionlevel2WhereInput = {
    ...
    mas_positionlevel1?: XOR<
      Mas_positionlevel1RelationFilter,
      mas_positionlevel1WhereInput
    > | null;
    mas_positionlevel3?: Mas_positionlevel3ListRelationFilter;
    Company?: XOR<CompanyRelationFilter, CompanyWhereInput> | null;
    mas_position_Id?: UuidFilter | string;
  ...
  export type mas_positionlevel3WhereInput = {
    ...
    mas_positionlevel2?: XOR<
      Mas_positionlevel2RelationFilter,
      mas_positionlevel2WhereInput
    > | null;
    mas_position_Id?: UuidFilter | string;
    mas_position?: XOR<
      Mas_positionRelationFilter,
  ...
  export type Position_userWhereInput = {
    ...
    mas_positionlevel2?: XOR<
      ...
      mas_positionlevel2WhereInput
    > | null;
    mas_positionlevel3?: XOR<
      Mas_positionlevel3RelationFilter,
      mas_positionlevel3WhereInput
    > | null;
  };
  ...
  export type CompanyBranchCreateNestedManyWithoutCompanyInput = {
    create?: XOR<
      Enumerable<CompanyBranchCreateWithoutCompanyInput>,
      Enumerable<CompanyBranchUncheckedCreateWithoutCompanyInput>
    >;
  ...
  export type mas_positionlevel3CreateNestedManyWithoutCompanyInput = {
    create?: XOR<
      Enumerable<mas_positionlevel3CreateWithoutCompanyInput>,
      Enumerable<mas_positionlevel3UncheckedCreateWithoutCompanyInput>
    >;
  ...
  export type mas_positionlevel2CreateNestedManyWithoutCompanyInput = {
    create?: XOR<
      Enumerable<mas_positionlevel2CreateWithoutCompanyInput>,
      Enumerable<mas_positionlevel2UncheckedCreateWithoutCompanyInput>
    >;
  ...
  export type mas_positionlevel1CreateNestedManyWithoutCompanyInput = {
    create?: XOR<
      Enumerable<mas_positionlevel1CreateWithoutCompanyInput>,
      Enumerable<mas_positionlevel1UncheckedCreateWithoutCompanyInput>
    >;
  ...
  export type holiday_dateCreateNestedManyWithoutCompanyInput = {
    create?: XOR<
      Enumerable<holiday_dateCreateWithoutCompanyInput>,
      Enumerable<holiday_dateUncheckedCreateWithoutCompanyInput>
    >;
  ...
  export type mas_positionCreateNestedManyWithoutCompanyInput = {
    create?: XOR<
      Enumerable<mas_positionCreateWithoutCompanyInput>,
      Enumerable<mas_positionUncheckedCreateWithoutCompanyInput>
    >;
  ...
  export type CompanyCreateNestedOneWithoutBranchInput = {
    create?: XOR<
      CompanyCreateWithoutBranchInput,
      CompanyUncheckedCreateWithoutBranchInput
    >;
  ...
  export type UserCreateNestedManyWithoutCompanyBranchInput = {
    create?: XOR<
      Enumerable<UserCreateWithoutCompanyBranchInput>,
      Enumerable<UserUncheckedCreateWithoutCompanyBranchInput>
    >;
  ...
  export type Role_CompanyCreateNestedManyWithoutCompanyBranchInput = {
    create?: XOR<
      Enumerable<Role_CompanyCreateWithoutCompanyBranchInput>,
      Enumerable<Role_CompanyUncheckedCreateWithoutCompanyBranchInput>
    >;
  ...
  export type CompanyUpdateOneWithoutBranchNestedInput = {
    ...
    connect?: CompanyWhereUniqueInput;
    update?: XOR<
      CompanyUpdateWithoutBranchInput,
      CompanyUncheckedUpdateWithoutBranchInput
    >;
  };
  ...
  export type CompanyCreateNestedManyWithoutOwnerInput = {
    create?: XOR<
      Enumerable<CompanyCreateWithoutOwnerInput>,
      Enumerable<CompanyUncheckedCreateWithoutOwnerInput>
    >;
  ...
  export type CompanyBranchCreateNestedOneWithoutUsersInput = {
    create?: XOR<
      CompanyBranchCreateWithoutUsersInput,
      CompanyBranchUncheckedCreateWithoutUsersInput
    >;
  ...
  export type Role_CompanyCreateNestedOneWithoutUsersInput = {
    create?: XOR<
      Role_CompanyCreateWithoutUsersInput,
      Role_CompanyUncheckedCreateWithoutUsersInput
    >;
  ...
  export type Position_userCreateNestedManyWithoutUserInput = {
    create?: XOR<
      Enumerable<Position_userCreateWithoutUserInput>,
      Enumerable<Position_userUncheckedCreateWithoutUserInput>
    >;
  ...
  export type CompanyBranchUpdateOneWithoutUsersNestedInput = {
    ...
    connect?: CompanyBranchWhereUniqueInput;
    update?: XOR<
      CompanyBranchUpdateWithoutUsersInput,
      CompanyBranchUncheckedUpdateWithoutUsersInput
    >;
  };
  ...
  export type Role_CompanyUpdateOneWithoutUsersNestedInput = {
    ...
    connect?: Role_CompanyWhereUniqueInput;
    update?: XOR<
      Role_CompanyUpdateWithoutUsersInput,
      Role_CompanyUncheckedUpdateWithoutUsersInput
    >;
  };
  ...
  export type UserCreateNestedManyWithoutRole_CompanyInput = {
    create?: XOR<
      Enumerable<UserCreateWithoutRole_CompanyInput>,
      Enumerable<UserUncheckedCreateWithoutRole_CompanyInput>
    >;
  ...
  export type CompanyBranchCreateNestedOneWithoutRole_CompanyInput = {
    create?: XOR<
      CompanyBranchCreateWithoutRole_CompanyInput,
      CompanyBranchUncheckedCreateWithoutRole_CompanyInput
    >;
  ...
  export type CompanyBranchUpdateOneWithoutRole_CompanyNestedInput = {
    ...
    connect?: CompanyBranchWhereUniqueInput;
    update?: XOR<
      CompanyBranchUpdateWithoutRole_CompanyInput,
      CompanyBranchUncheckedUpdateWithoutRole_CompanyInput
    >;
  };
  ...
  export type DistrictCreateNestedManyWithoutProvinceInput = {
    create?: XOR<
      Enumerable<DistrictCreateWithoutProvinceInput>,
      Enumerable<DistrictUncheckedCreateWithoutProvinceInput>
    >;
  ...
  export type ProvinceCreateNestedOneWithoutDistrictInput = {
    create?: XOR<
      ProvinceCreateWithoutDistrictInput,
      ProvinceUncheckedCreateWithoutDistrictInput
    >;
  ...
  export type AmphoeCreateNestedManyWithoutDistrictInput = {
    create?: XOR<
      Enumerable<AmphoeCreateWithoutDistrictInput>,
      Enumerable<AmphoeUncheckedCreateWithoutDistrictInput>
    >;
  ...
  export type ProvinceUpdateOneRequiredWithoutDistrictNestedInput = {
    ...
    connect?: ProvinceWhereUniqueInput;
    update?: XOR<
      ProvinceUpdateWithoutDistrictInput,
      ProvinceUncheckedUpdateWithoutDistrictInput
    >;
  };
  ...
  export type DistrictCreateNestedOneWithoutAmphoeInput = {
    create?: XOR<
      DistrictCreateWithoutAmphoeInput,
      DistrictUncheckedCreateWithoutAmphoeInput
    >;
  ...
  export type DistrictUpdateOneRequiredWithoutAmphoeNestedInput = {
    ...
    connect?: DistrictWhereUniqueInput;
    update?: XOR<
      DistrictUpdateWithoutAmphoeInput,
      DistrictUncheckedUpdateWithoutAmphoeInput
    >;
  };

  export type mas_positionlevel1CreateNestedManyWithoutMas_positionInput = {
    create?: XOR<
      Enumerable<mas_positionlevel1CreateWithoutMas_positionInput>,
      Enumerable<mas_positionlevel1UncheckedCreateWithoutMas_positionInput>
    >;
  ...
  export type mas_positionlevel2CreateNestedManyWithoutMas_positionInput = {
    create?: XOR<
      Enumerable<mas_positionlevel2CreateWithoutMas_positionInput>,
      Enumerable<mas_positionlevel2UncheckedCreateWithoutMas_positionInput>
    >;
  ...
  export type mas_positionlevel3CreateNestedManyWithoutMas_positionInput = {
    create?: XOR<
      Enumerable<mas_positionlevel3CreateWithoutMas_positionInput>,
      Enumerable<mas_positionlevel3UncheckedCreateWithoutMas_positionInput>
    >;
  ...
  export type CompanyCreateNestedOneWithoutMas_positionInput = {
    create?: XOR<
      CompanyCreateWithoutMas_positionInput,
      CompanyUncheckedCreateWithoutMas_positionInput
    >;
  ...
  export type CompanyUpdateOneWithoutMas_positionNestedInput = {
    ...
    connect?: CompanyWhereUniqueInput;
    update?: XOR<
      CompanyUpdateWithoutMas_positionInput,
      CompanyUncheckedUpdateWithoutMas_positionInput
    >;
  };
  ...
  export type mas_positionCreateNestedOneWithoutMas_positionlevel1Input = {
    create?: XOR<
      mas_positionCreateWithoutMas_positionlevel1Input,
      mas_positionUncheckedCreateWithoutMas_positionlevel1Input
    >;
  ...
  export type mas_positionlevel2CreateNestedManyWithoutMas_positionlevel1Input =
    {
      create?: XOR<
        Enumerable<mas_positionlevel2CreateWithoutMas_positionlevel1Input>,
        Enumerable<mas_positionlevel2UncheckedCreateWithoutMas_positionlevel1Input>
      >;
  ...
  export type CompanyCreateNestedOneWithoutMas_positionlevel1Input = {
    create?: XOR<
      CompanyCreateWithoutMas_positionlevel1Input,
      CompanyUncheckedCreateWithoutMas_positionlevel1Input
    >;
  ...
  export type Position_userCreateNestedManyWithoutMas_positionlevel1Input = {
    create?: XOR<
      Enumerable<Position_userCreateWithoutMas_positionlevel1Input>,
      Enumerable<Position_userUncheckedCreateWithoutMas_positionlevel1Input>
    >;
  ...
  export type mas_positionUpdateOneWithoutMas_positionlevel1NestedInput = {
    ...
    connect?: mas_positionWhereUniqueInput;
    update?: XOR<
      mas_positionUpdateWithoutMas_positionlevel1Input,
      mas_positionUncheckedUpdateWithoutMas_positionlevel1Input
    >;
  };
  ...
  export type CompanyUpdateOneWithoutMas_positionlevel1NestedInput = {
    ...
    connect?: CompanyWhereUniqueInput;
    update?: XOR<
      CompanyUpdateWithoutMas_positionlevel1Input,
      CompanyUncheckedUpdateWithoutMas_positionlevel1Input
    >;
  };
  ...
  export type mas_positionlevel1CreateNestedOneWithoutMas_positionlevel2Input =
    {
      create?: XOR<
        mas_positionlevel1CreateWithoutMas_positionlevel2Input,
        mas_positionlevel1UncheckedCreateWithoutMas_positionlevel2Input
      >;
  ...
  export type mas_positionlevel3CreateNestedManyWithoutMas_positionlevel2Input =
    {
      create?: XOR<
        Enumerable<mas_positionlevel3CreateWithoutMas_positionlevel2Input>,
        Enumerable<mas_positionlevel3UncheckedCreateWithoutMas_positionlevel2Input>
      >;
  ...
  export type CompanyCreateNestedOneWithoutMas_positionlevel2Input = {
    create?: XOR<
      CompanyCreateWithoutMas_positionlevel2Input,
      CompanyUncheckedCreateWithoutMas_positionlevel2Input
    >;
  ...
  export type mas_positionCreateNestedOneWithoutMas_positionlevel2Input = {
    create?: XOR<
      mas_positionCreateWithoutMas_positionlevel2Input,
      mas_positionUncheckedCreateWithoutMas_positionlevel2Input
    >;
  ...
  export type Position_userCreateNestedManyWithoutMas_positionlevel2Input = {
    create?: XOR<
      Enumerable<Position_userCreateWithoutMas_positionlevel2Input>,
      Enumerable<Position_userUncheckedCreateWithoutMas_positionlevel2Input>
    >;
  ...
  export type mas_positionlevel1UpdateOneWithoutMas_positionlevel2NestedInput =
    {
      ...
      connect?: mas_positionlevel1WhereUniqueInput;
      update?: XOR<
        mas_positionlevel1UpdateWithoutMas_positionlevel2Input,
        mas_positionlevel1UncheckedUpdateWithoutMas_positionlevel2Input
      >;
    };
  ...
  export type CompanyUpdateOneWithoutMas_positionlevel2NestedInput = {
    ...
    connect?: CompanyWhereUniqueInput;
    update?: XOR<
      CompanyUpdateWithoutMas_positionlevel2Input,
      CompanyUncheckedUpdateWithoutMas_positionlevel2Input
    >;
  };
  ...
  export type mas_positionUpdateOneWithoutMas_positionlevel2NestedInput = {
    ...
    connect?: mas_positionWhereUniqueInput;
    update?: XOR<
      mas_positionUpdateWithoutMas_positionlevel2Input,
      mas_positionUncheckedUpdateWithoutMas_positionlevel2Input
    >;
  };
  ...
  export type mas_positionlevel2CreateNestedOneWithoutMas_positionlevel3Input =
    {
      create?: XOR<
        mas_positionlevel2CreateWithoutMas_positionlevel3Input,
        mas_positionlevel2UncheckedCreateWithoutMas_positionlevel3Input
      >;
  ...
  export type mas_positionCreateNestedOneWithoutMas_positionlevel3Input = {
    create?: XOR<
      mas_positionCreateWithoutMas_positionlevel3Input,
      mas_positionUncheckedCreateWithoutMas_positionlevel3Input
    >;
  ...
  export type CompanyCreateNestedOneWithoutMas_positionlevel3Input = {
    create?: XOR<
      CompanyCreateWithoutMas_positionlevel3Input,
      CompanyUncheckedCreateWithoutMas_positionlevel3Input
    >;
  ...
  export type Position_userCreateNestedManyWithoutMas_positionlevel3Input = {
    create?: XOR<
      Enumerable<Position_userCreateWithoutMas_positionlevel3Input>,
      Enumerable<Position_userUncheckedCreateWithoutMas_positionlevel3Input>
    >;
  ...
  export type mas_positionlevel2UpdateOneWithoutMas_positionlevel3NestedInput =
    {
      ...
      connect?: mas_positionlevel2WhereUniqueInput;
      update?: XOR<
        mas_positionlevel2UpdateWithoutMas_positionlevel3Input,
        mas_positionlevel2UncheckedUpdateWithoutMas_positionlevel3Input
      >;
    };
  ...
  export type mas_positionUpdateOneWithoutMas_positionlevel3NestedInput = {
    ...
    connect?: mas_positionWhereUniqueInput;
    update?: XOR<
      mas_positionUpdateWithoutMas_positionlevel3Input,
      mas_positionUncheckedUpdateWithoutMas_positionlevel3Input
    >;
  };
  ...
  export type CompanyUpdateOneWithoutMas_positionlevel3NestedInput = {
    ...
    connect?: CompanyWhereUniqueInput;
    update?: XOR<
      CompanyUpdateWithoutMas_positionlevel3Input,
      CompanyUncheckedUpdateWithoutMas_positionlevel3Input
    >;
  };
  ...
  export type UserCreateNestedOneWithoutPosition_userInput = {
    create?: XOR<
      UserCreateWithoutPosition_userInput,
      UserUncheckedCreateWithoutPosition_userInput
    >;
  ...
  export type mas_positionlevel1CreateNestedOneWithoutPosition_userInput = {
    create?: XOR<
      mas_positionlevel1CreateWithoutPosition_userInput,
      mas_positionlevel1UncheckedCreateWithoutPosition_userInput
    >;
  ...
  export type mas_positionlevel2CreateNestedOneWithoutPosition_userInput = {
    create?: XOR<
      mas_positionlevel2CreateWithoutPosition_userInput,
      mas_positionlevel2UncheckedCreateWithoutPosition_userInput
    >;
  ...
  export type mas_positionlevel3CreateNestedOneWithoutPosition_userInput = {
    create?: XOR<
      mas_positionlevel3CreateWithoutPosition_userInput,
      mas_positionlevel3UncheckedCreateWithoutPosition_userInput
    >;
  ...
  export type UserUpdateOneWithoutPosition_userNestedInput = {
    ...
    connect?: UserWhereUniqueInput;
    update?: XOR<
      UserUpdateWithoutPosition_userInput,
      UserUncheckedUpdateWithoutPosition_userInput
    >;
  };
  ...
  export type mas_positionlevel1UpdateOneWithoutPosition_userNestedInput = {
    ...
    connect?: mas_positionlevel1WhereUniqueInput;
    update?: XOR<
      mas_positionlevel1UpdateWithoutPosition_userInput,
      mas_positionlevel1UncheckedUpdateWithoutPosition_userInput
    >;
  };
  ...
  export type mas_positionlevel2UpdateOneWithoutPosition_userNestedInput = {
    ...
    connect?: mas_positionlevel2WhereUniqueInput;
    update?: XOR<
      mas_positionlevel2UpdateWithoutPosition_userInput,
      mas_positionlevel2UncheckedUpdateWithoutPosition_userInput
    >;
  };
  ...
  export type mas_positionlevel3UpdateOneWithoutPosition_userNestedInput = {
    ...
    connect?: mas_positionlevel3WhereUniqueInput;
    update?: XOR<
      mas_positionlevel3UpdateWithoutPosition_userInput,
      mas_positionlevel3UncheckedUpdateWithoutPosition_userInput
    >;
  };

  export type CompanyCreateNestedOneWithoutHoliday_dateInput = {
    create?: XOR<
      CompanyCreateWithoutHoliday_dateInput,
      CompanyUncheckedCreateWithoutHoliday_dateInput
    >;
  ...
  export type CompanyUpdateOneWithoutHoliday_dateNestedInput = {
    ...
    connect?: CompanyWhereUniqueInput;
    update?: XOR<
      CompanyUpdateWithoutHoliday_dateInput,
      CompanyUncheckedUpdateWithoutHoliday_dateInput
    >;
  };
  ...
  export type CompanyBranchCreateOrConnectWithoutCompanyInput = {
    where: CompanyBranchWhereUniqueInput;
    create: XOR<
      CompanyBranchCreateWithoutCompanyInput,
      CompanyBranchUncheckedCreateWithoutCompanyInput
    >;
  };
  ...
  export type mas_positionlevel3CreateOrConnectWithoutCompanyInput = {
    where: mas_positionlevel3WhereUniqueInput;
    create: XOR<
      mas_positionlevel3CreateWithoutCompanyInput,
      mas_positionlevel3UncheckedCreateWithoutCompanyInput
    >;
  };
  ...
  export type mas_positionlevel2CreateOrConnectWithoutCompanyInput = {
    where: mas_positionlevel2WhereUniqueInput;
    create: XOR<
      mas_positionlevel2CreateWithoutCompanyInput,
      mas_positionlevel2UncheckedCreateWithoutCompanyInput
    >;
  };
  ...
  export type mas_positionlevel1CreateOrConnectWithoutCompanyInput = {
    where: mas_positionlevel1WhereUniqueInput;
    create: XOR<
      mas_positionlevel1CreateWithoutCompanyInput,
      mas_positionlevel1UncheckedCreateWithoutCompanyInput
    >;
  };
  ...
  export type holiday_dateCreateOrConnectWithoutCompanyInput = {
    where: holiday_dateWhereUniqueInput;
    create: XOR<
      holiday_dateCreateWithoutCompanyInput,
      holiday_dateUncheckedCreateWithoutCompanyInput
    >;
  };
  ...
  export type mas_positionCreateOrConnectWithoutCompanyInput = {
    where: mas_positionWhereUniqueInput;
    create: XOR<
      mas_positionCreateWithoutCompanyInput,
      mas_positionUncheckedCreateWithoutCompanyInput
    >;
  };
  ...
  export type CompanyBranchUpsertWithWhereUniqueWithoutCompanyInput = {
    where: CompanyBranchWhereUniqueInput;
    update: XOR<
      CompanyBranchUpdateWithoutCompanyInput,
      CompanyBranchUncheckedUpdateWithoutCompanyInput
    >;
    create: XOR<
      CompanyBranchCreateWithoutCompanyInput,
      CompanyBranchUncheckedCreateWithoutCompanyInput
  ...
  export type CompanyBranchUpdateManyWithWhereWithoutCompanyInput = {
    ...
    data: XOR<
      CompanyBranchUpdateManyMutationInput,
      CompanyBranchUncheckedUpdateManyWithoutBranchInput
    >;
  };
  ...
  export type mas_positionlevel3UpsertWithWhereUniqueWithoutCompanyInput = {
    where: mas_positionlevel3WhereUniqueInput;
    update: XOR<
      mas_positionlevel3UpdateWithoutCompanyInput,
      mas_positionlevel3UncheckedUpdateWithoutCompanyInput
    >;
    create: XOR<
      mas_positionlevel3CreateWithoutCompanyInput,
      mas_positionlevel3UncheckedCreateWithoutCompanyInput
  ...
  export type mas_positionlevel3UpdateManyWithWhereWithoutCompanyInput = {
    ...
    data: XOR<
      mas_positionlevel3UpdateManyMutationInput,
      mas_positionlevel3UncheckedUpdateManyWithoutMas_positionlevel3Input
    >;
  };
  ...
  export type mas_positionlevel2UpsertWithWhereUniqueWithoutCompanyInput = {
    where: mas_positionlevel2WhereUniqueInput;
    update: XOR<
      mas_positionlevel2UpdateWithoutCompanyInput,
      mas_positionlevel2UncheckedUpdateWithoutCompanyInput
    >;
    create: XOR<
      mas_positionlevel2CreateWithoutCompanyInput,
      mas_positionlevel2UncheckedCreateWithoutCompanyInput
  ...
  export type mas_positionlevel2UpdateManyWithWhereWithoutCompanyInput = {
    ...
    data: XOR<
      mas_positionlevel2UpdateManyMutationInput,
      mas_positionlevel2UncheckedUpdateManyWithoutMas_positionlevel2Input
    >;
  };
  ...
  export type mas_positionlevel1UpsertWithWhereUniqueWithoutCompanyInput = {
    where: mas_positionlevel1WhereUniqueInput;
    update: XOR<
      mas_positionlevel1UpdateWithoutCompanyInput,
      mas_positionlevel1UncheckedUpdateWithoutCompanyInput
    >;
    create: XOR<
      mas_positionlevel1CreateWithoutCompanyInput,
      mas_positionlevel1UncheckedCreateWithoutCompanyInput
  ...
  export type mas_positionlevel1UpdateManyWithWhereWithoutCompanyInput = {
    ...
    data: XOR<
      mas_positionlevel1UpdateManyMutationInput,
      mas_positionlevel1UncheckedUpdateManyWithoutMas_positionlevel1Input
    >;
  };
  ...
  export type holiday_dateUpsertWithWhereUniqueWithoutCompanyInput = {
    where: holiday_dateWhereUniqueInput;
    update: XOR<
      holiday_dateUpdateWithoutCompanyInput,
      holiday_dateUncheckedUpdateWithoutCompanyInput
    >;
    create: XOR<
      holiday_dateCreateWithoutCompanyInput,
      holiday_dateUncheckedCreateWithoutCompanyInput
  ...
  export type holiday_dateUpdateManyWithWhereWithoutCompanyInput = {
    ...
    data: XOR<
      holiday_dateUpdateManyMutationInput,
      holiday_dateUncheckedUpdateManyWithoutHoliday_dateInput
    >;
  };
  ...
  export type mas_positionUpsertWithWhereUniqueWithoutCompanyInput = {
    where: mas_positionWhereUniqueInput;
    update: XOR<
      mas_positionUpdateWithoutCompanyInput,
      mas_positionUncheckedUpdateWithoutCompanyInput
    >;
    create: XOR<
      mas_positionCreateWithoutCompanyInput,
      mas_positionUncheckedCreateWithoutCompanyInput
  ...
  export type mas_positionUpdateManyWithWhereWithoutCompanyInput = {
    ...
    data: XOR<
      mas_positionUpdateManyMutationInput,
      mas_positionUncheckedUpdateManyWithoutMas_positionInput
    >;
  };
  ...
  export type UserCreateOrConnectWithoutCompanyBranchInput = {
    where: UserWhereUniqueInput;
    create: XOR<
      UserCreateWithoutCompanyBranchInput,
      UserUncheckedCreateWithoutCompanyBranchInput
    >;
  };
  ...
  export type Role_CompanyCreateOrConnectWithoutCompanyBranchInput = {
    where: Role_CompanyWhereUniqueInput;
    create: XOR<
      Role_CompanyCreateWithoutCompanyBranchInput,
      Role_CompanyUncheckedCreateWithoutCompanyBranchInput
    >;
  };
  ...
  export type UserUpsertWithWhereUniqueWithoutCompanyBranchInput = {
    where: UserWhereUniqueInput;
    update: XOR<
      UserUpdateWithoutCompanyBranchInput,
      UserUncheckedUpdateWithoutCompanyBranchInput
    >;
    create: XOR<
      UserCreateWithoutCompanyBranchInput,
      UserUncheckedCreateWithoutCompanyBranchInput
  ...
  export type Role_CompanyUpsertWithWhereUniqueWithoutCompanyBranchInput = {
    where: Role_CompanyWhereUniqueInput;
    update: XOR<
      Role_CompanyUpdateWithoutCompanyBranchInput,
      Role_CompanyUncheckedUpdateWithoutCompanyBranchInput
    >;
    create: XOR<
      Role_CompanyCreateWithoutCompanyBranchInput,
      Role_CompanyUncheckedCreateWithoutCompanyBranchInput
  ...
  export type Role_CompanyUpdateManyWithWhereWithoutCompanyBranchInput = {
    ...
    data: XOR<
      Role_CompanyUpdateManyMutationInput,
      Role_CompanyUncheckedUpdateManyWithoutRole_CompanyInput
    >;
  };
  ...
  export type CompanyCreateOrConnectWithoutOwnerInput = {
    where: CompanyWhereUniqueInput;
    create: XOR<
      CompanyCreateWithoutOwnerInput,
      CompanyUncheckedCreateWithoutOwnerInput
    >;
  };
  ...
  export type Position_userCreateOrConnectWithoutUserInput = {
    where: Position_userWhereUniqueInput;
    create: XOR<
      Position_userCreateWithoutUserInput,
      Position_userUncheckedCreateWithoutUserInput
    >;
  };
  ...
  export type CompanyUpsertWithWhereUniqueWithoutOwnerInput = {
    where: CompanyWhereUniqueInput;
    update: XOR<
      CompanyUpdateWithoutOwnerInput,
  ...
  export type CompanyUpdateManyWithWhereWithoutOwnerInput = {
    ...
    data: XOR<
      ...
      CompanyUncheckedUpdateManyWithoutCompanyInput
    >;
  };
  ...
  export type Position_userUpsertWithWhereUniqueWithoutUserInput = {
    where: Position_userWhereUniqueInput;
    update: XOR<
      Position_userUpdateWithoutUserInput,
      Position_userUncheckedUpdateWithoutUserInput
    >;
    create: XOR<
      Position_userCreateWithoutUserInput,
      Position_userUncheckedCreateWithoutUserInput
  ...
  export type Position_userUpdateManyWithWhereWithoutUserInput = {
    ...
    data: XOR<
      Position_userUpdateManyMutationInput,
      Position_userUncheckedUpdateManyWithoutPosition_userInput
    >;
  };
  ...
  export type UserCreateOrConnectWithoutRole_CompanyInput = {
    where: UserWhereUniqueInput;
    create: XOR<
      UserCreateWithoutRole_CompanyInput,
      UserUncheckedCreateWithoutRole_CompanyInput
    >;
  };
  ...
  export type UserUpsertWithWhereUniqueWithoutRole_CompanyInput = {
    where: UserWhereUniqueInput;
    update: XOR<
      UserUpdateWithoutRole_CompanyInput,
      UserUncheckedUpdateWithoutRole_CompanyInput
    >;
    create: XOR<
      UserCreateWithoutRole_CompanyInput,
      UserUncheckedCreateWithoutRole_CompanyInput
  ...
  export type DistrictCreateOrConnectWithoutProvinceInput = {
    ...
    create: XOR<
      ...
      DistrictUncheckedCreateWithoutProvinceInput
    >;
  };
  ...
  export type DistrictUpsertWithWhereUniqueWithoutProvinceInput = {
    where: DistrictWhereUniqueInput;
    update: XOR<
      DistrictUpdateWithoutProvinceInput,
      DistrictUncheckedUpdateWithoutProvinceInput
    >;
    create: XOR<
      DistrictCreateWithoutProvinceInput,
      DistrictUncheckedCreateWithoutProvinceInput
  ...
  export type DistrictUpdateManyWithWhereWithoutProvinceInput = {
    ...
    data: XOR<
      DistrictUpdateManyMutationInput,
      DistrictUncheckedUpdateManyWithoutDistrictInput
    >;
  };
  ...
  export type AmphoeCreateOrConnectWithoutDistrictInput = {
    where: AmphoeWhereUniqueInput;
    create: XOR<
      AmphoeCreateWithoutDistrictInput,
      AmphoeUncheckedCreateWithoutDistrictInput
    >;
  };
  ...
  export type AmphoeUpsertWithWhereUniqueWithoutDistrictInput = {
    where: AmphoeWhereUniqueInput;
    update: XOR<
      AmphoeUpdateWithoutDistrictInput,
      AmphoeUncheckedUpdateWithoutDistrictInput
    >;
    create: XOR<
      AmphoeCreateWithoutDistrictInput,
      AmphoeUncheckedCreateWithoutDistrictInput
  ...
  export type AmphoeUpdateManyWithWhereWithoutDistrictInput = {
    ...
    data: XOR<
      AmphoeUpdateManyMutationInput,
      AmphoeUncheckedUpdateManyWithoutAmphoeInput
    >;
  };
  ...
  export type mas_positionlevel1CreateOrConnectWithoutMas_positionInput = {
    where: mas_positionlevel1WhereUniqueInput;
    create: XOR<
      mas_positionlevel1CreateWithoutMas_positionInput,
      mas_positionlevel1UncheckedCreateWithoutMas_positionInput
    >;
  };
  ...
  export type mas_positionlevel2CreateOrConnectWithoutMas_positionInput = {
    where: mas_positionlevel2WhereUniqueInput;
    create: XOR<
      mas_positionlevel2CreateWithoutMas_positionInput,
      mas_positionlevel2UncheckedCreateWithoutMas_positionInput
    >;
  };
  ...
  export type mas_positionlevel3CreateOrConnectWithoutMas_positionInput = {
    where: mas_positionlevel3WhereUniqueInput;
    create: XOR<
      mas_positionlevel3CreateWithoutMas_positionInput,
      mas_positionlevel3UncheckedCreateWithoutMas_positionInput
    >;
  };
  ...
  export type mas_positionlevel1UpsertWithWhereUniqueWithoutMas_positionInput =
    {
      where: mas_positionlevel1WhereUniqueInput;
      update: XOR<
        mas_positionlevel1UpdateWithoutMas_positionInput,
        mas_positionlevel1UncheckedUpdateWithoutMas_positionInput
      >;
      create: XOR<
        mas_positionlevel1CreateWithoutMas_positionInput,
        mas_positionlevel1UncheckedCreateWithoutMas_positionInput
  ...
  export type mas_positionlevel2UpsertWithWhereUniqueWithoutMas_positionInput =
    {
      where: mas_positionlevel2WhereUniqueInput;
      update: XOR<
        mas_positionlevel2UpdateWithoutMas_positionInput,
        mas_positionlevel2UncheckedUpdateWithoutMas_positionInput
      >;
      create: XOR<
        mas_positionlevel2CreateWithoutMas_positionInput,
        mas_positionlevel2UncheckedCreateWithoutMas_positionInput
  ...
  export type mas_positionlevel3UpsertWithWhereUniqueWithoutMas_positionInput =
    {
      where: mas_positionlevel3WhereUniqueInput;
      update: XOR<
        mas_positionlevel3UpdateWithoutMas_positionInput,
        mas_positionlevel3UncheckedUpdateWithoutMas_positionInput
      >;
      create: XOR<
        mas_positionlevel3CreateWithoutMas_positionInput,
        mas_positionlevel3UncheckedCreateWithoutMas_positionInput
  ...
  export type mas_positionlevel2CreateOrConnectWithoutMas_positionlevel1Input =
    {
      where: mas_positionlevel2WhereUniqueInput;
      create: XOR<
        mas_positionlevel2CreateWithoutMas_positionlevel1Input,
        mas_positionlevel2UncheckedCreateWithoutMas_positionlevel1Input
      >;
    };
  ...
  export type Position_userCreateOrConnectWithoutMas_positionlevel1Input = {
    where: Position_userWhereUniqueInput;
    create: XOR<
      Position_userCreateWithoutMas_positionlevel1Input,
      Position_userUncheckedCreateWithoutMas_positionlevel1Input
    >;
  };
  ...
  export type mas_positionlevel2UpsertWithWhereUniqueWithoutMas_positionlevel1Input =
    {
      where: mas_positionlevel2WhereUniqueInput;
      update: XOR<
        mas_positionlevel2UpdateWithoutMas_positionlevel1Input,
        mas_positionlevel2UncheckedUpdateWithoutMas_positionlevel1Input
      >;
      create: XOR<
        mas_positionlevel2CreateWithoutMas_positionlevel1Input,
        mas_positionlevel2UncheckedCreateWithoutMas_positionlevel1Input
  ...
  export type Position_userUpsertWithWhereUniqueWithoutMas_positionlevel1Input =
    {
      where: Position_userWhereUniqueInput;
      update: XOR<
        Position_userUpdateWithoutMas_positionlevel1Input,
        Position_userUncheckedUpdateWithoutMas_positionlevel1Input
      >;
      create: XOR<
        Position_userCreateWithoutMas_positionlevel1Input,
        Position_userUncheckedCreateWithoutMas_positionlevel1Input
  ...
  export type mas_positionlevel3CreateOrConnectWithoutMas_positionlevel2Input =
    {
      where: mas_positionlevel3WhereUniqueInput;
      create: XOR<
        mas_positionlevel3CreateWithoutMas_positionlevel2Input,
        mas_positionlevel3UncheckedCreateWithoutMas_positionlevel2Input
      >;
    };
  ...
  export type Position_userCreateOrConnectWithoutMas_positionlevel2Input = {
    where: Position_userWhereUniqueInput;
    create: XOR<
      Position_userCreateWithoutMas_positionlevel2Input,
      Position_userUncheckedCreateWithoutMas_positionlevel2Input
    >;
  };
  ...
  export type mas_positionlevel3UpsertWithWhereUniqueWithoutMas_positionlevel2Input =
    {
      where: mas_positionlevel3WhereUniqueInput;
      update: XOR<
        mas_positionlevel3UpdateWithoutMas_positionlevel2Input,
        mas_positionlevel3UncheckedUpdateWithoutMas_positionlevel2Input
      >;
      create: XOR<
        mas_positionlevel3CreateWithoutMas_positionlevel2Input,
        mas_positionlevel3UncheckedCreateWithoutMas_positionlevel2Input
  ...
  export type Position_userUpsertWithWhereUniqueWithoutMas_positionlevel2Input =
    {
      where: Position_userWhereUniqueInput;
      update: XOR<
        Position_userUpdateWithoutMas_positionlevel2Input,
        Position_userUncheckedUpdateWithoutMas_positionlevel2Input
      >;
      create: XOR<
        Position_userCreateWithoutMas_positionlevel2Input,
        Position_userUncheckedCreateWithoutMas_positionlevel2Input
  ...
  export type Position_userCreateOrConnectWithoutMas_positionlevel3Input = {
    where: Position_userWhereUniqueInput;
    create: XOR<
      Position_userCreateWithoutMas_positionlevel3Input,
      Position_userUncheckedCreateWithoutMas_positionlevel3Input
    >;
  };
  ...
  export type Position_userUpsertWithWhereUniqueWithoutMas_positionlevel3Input =
    {
      where: Position_userWhereUniqueInput;
      update: XOR<
        Position_userUpdateWithoutMas_positionlevel3Input,
        Position_userUncheckedUpdateWithoutMas_positionlevel3Input
      >;
      create: XOR<
        Position_userCreateWithoutMas_positionlevel3Input,
        Position_userUncheckedCreateWithoutMas_positionlevel3Input
